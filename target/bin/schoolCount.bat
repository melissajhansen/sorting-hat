...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="schoolCount" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" SchoolFinder %CMD_LINE_ARGS%
